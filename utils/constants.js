export const KINDEEM_BASE_URL = 'https://api.devwebcompras.shop'

export const BASE_URL = process.env.NODE_ENV === 'production' ? 'https://api.devwebcompras.shop' : process.env.SERVER_BASE_URL
